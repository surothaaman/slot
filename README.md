...
<html>
<head>
    <title>SLOT TIME TABLE - 23008504(SUROTHAAMAN R) </title>
    <style>
        table {
...
<body>
    ...
    <div class="center-text">
        <p><strong>SLOT TIME TABLE - 23008504(SUROTHAAMAN R) </strong></p>
    </div>
    <table>
        <tr>
...
```
## OUTPUT
![Screenshot (59)](https://github.com/surothaaman/slot/assets/133313653/f5afb1be-aa8a-4dbf-a1a5-ed9e35fe46eb)
